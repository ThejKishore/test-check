package com.kish.material.views.transactionlandingpage;

import com.kish.material.data.entity.SamplePerson;
import com.kish.material.data.service.SamplePersonService;
import com.kish.material.views.MainLayout;
...
@Route(value = "transactionLandingPage/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
