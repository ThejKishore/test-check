package com.kish.material.views;


import com.kish.material.views.personform.PersonFormView;
import com.kish.material.views.transaction.TransactionView;
import com.kish.material.views.transactionlandingpage.TransactionLandingPageView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Transaction", "", TransactionView.class), //

                new MenuItemInfo("TransactionLandingPage", "la la-columns", TransactionLandingPageView.class), //
